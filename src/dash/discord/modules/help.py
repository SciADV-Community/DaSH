...
cmdList = {
    "start": [
        "<*game>",
        "Creates a new game room. Only one can exist per person at a time.",
        0,
    ],
    "chapter": ["<number>", "Gives completion role for chapter.", 0],
    "finished": ["", "Closes room, gives completion role for game.", 0],
    "addgame": [
        "<game> <suffix> <complRole> <playCat> <complCat> <purgeRole>",
    ...
    "rmgame": [
        "<game>",
        "Removes game and game roles from the server game options.",
        1,
    ],
    "addrole": [
        "<game> <role> <*reqs>",
        "Add role for a game. Takes multiple reqs. "
        "Using * lets you add a series role.",
        1,
    ],
    "listroles": [
        "<?game>",
        "Lists roles of a game. If no game is specified, shows server roles.",
        0,
    ],
    "rmrole": [
        "<game> <role>",
        "Removes a role from a game. Using * lets you remove a series role.",
        1,
    ],
    "auth": [
        "<role>",
        "Adds roles to be authorized for administrative bot commands. Can have multiple.",
        2,
    ],
...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed = discord.Embed(
            title="DaSH 1st Edition Ver. 1.19",
            description="DaSH Command Help",
            color=0xCB6326,
        )
